export async function onRequest(context){
  ...
  const prompt=[
    ...
    "19. 【适合聊的话题】需要给出user今天可以自然发给郁绥的聊天方向，必须像正常聊天，不要像心理咨询、哲学提问、作文题或深度访谈。",
    "20. 聊天话题要具体、短、低压力，可以围绕日常小事、工作见闻、天气、食物、物品损坏、临时变动、简单选择题展开。",
    "21. 聊天话题可以轻微结合Tavo和郁绥的冷静性格，但不要要求郁绥剖白内心，不要诱导郁绥解释过去，不要逼问感情。",
    "22. 【今日提醒】需要给出一条具体、可执行的提醒，帮助user今天更稳定地处理情绪、行动或沟通。",
    "23. 输出内容中不要使用英文双引号，如需引用问题，请使用中文引号“”。"
  ].join("\n");
